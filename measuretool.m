...
uicontrol('String','Help',...
    'ToolTipString','open the documentation',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Options',...
    'ToolTipString','open the options panel',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Remove',...
    'ToolTipString','remove the selectiond images from the list',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Save Project',...
    'ToolTipString','Save all measurement to a .mat file which can be opened with this tool',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(3),dx,dy],...
...
uicontrol('String','Load Project',...
    'ToolTipString','Load a .mat file that is previously saved using this tool',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(2),dx,dy],...
...
uicontrol('String','Save to Text',...
    'ToolTipString','Write all data to formatted text file',...
    'Style','pushbutton',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(3),y0(2),dx,dy],...
...
Hb.plotcolor(1) = uicontrol('String',colornames,...
    'ToolTipString','Select one of the plot colors',...
    'Style','popupmenu',...
    'Value',PlotColors(1),...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
Hb.plotmarker(1) = uicontrol('String',markers,...
    'ToolTipString','Select one of the plot markers',...
    'Style','popupmenu',...
    'Value',PlotMarkers(1),...
    'Units','normalized',...
    'FontSize',fontsize(2),...
...
uicontrol('String','Font Size',...
    ...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(8),dx,dy],...
    'Parent',Hp(6));
Hb.fontsize = uicontrol('String',num2str(fontsize(3)),...
    'ToolTipString','Font size of the measurement labels',...
    'Style','Edit',...
    'HorizontalAlignment','center',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(2),y0(8),dx,dy],...
    'call',@options_fun,...
    'Parent',Hp(6));
uicontrol('String','Text Box Alpha',...
    ...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(9),dx,dy],...
    'Parent',Hp(6));
Hb.textboxalpha = uicontrol('String',num2str(TextBoxAlpha),...
    'ToolTipString','Set the transperancy of the text boxes (between 0 and 1)',...
    'Style','Edit',...
    'HorizontalAlignment','center',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(2),y0(9),dx,dy],...
    'call',@options_fun,...
    'Parent',Hp(6));
...
Hb.autoedit = uicontrol('String','Auto Edit',...
    ...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(11),x0(3)-x0(1),dy],...
    'call',@options_fun,...
    'Parent',Hp(6));
Hb.zoomselect = uicontrol('String','Zoom Select (Z)',...
    'ToolTipString','Zoom the image around the region of interst before selecting a point',...
    'Style','checkbox',...
    'Value',ZoomSelect,...
    'HorizontalAlignment','left',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(12),x0(3)-x0(1),dy],...
    'call',@options_fun,...
    'Parent',Hp(6));
uicontrol('String','Zoom Box Size',...
    ...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(13),dx,dy],...
    'Parent',Hp(6));
Hb.zoombox = uicontrol('String',num2str(ZoomBox),...
    'ToolTipString','The size of the zoom box in pixels when using ZoomSelect',...
    'Style','Edit',...
    'HorizontalAlignment','center',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(2),y0(13),dx,dy],...
    'call',@options_fun,...
    'Parent',Hp(6));
Hb.showall = uicontrol('String','Show All',...
    'ToolTipString','Show all measurements on each image, instead of only those meaured on the image',...
    'Style','checkbox',...
    'Value',ShowAll,...
    'HorizontalAlignment','left',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(15),x0(3)-x0(1),dy],...
    'call',@options_fun,...
    'Parent',Hp(6));
uicontrol('String','Number of points',...
    ...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(1),y0(16),dx,dy],...
    'Parent',Hp(6));
Hb.Npoints = uicontrol('String',num2str(Npoints),...
    'ToolTipString','The number of interpolation points to use (only for Spline and Circle)',...
    'Style','Edit',...
    'HorizontalAlignment','center',...
    'Units','normalized',...
    'FontSize',fontsize(2),...
    'Position',[x0(2),y0(16),dx,dy],...
    'call',@options_fun,...
    'Parent',Hp(6));
...
% Copy ------------------------
    function copy_move(varargin)
        ...
        for k = 1:4
            Htmp(k).XData = copy_obj_in_memory.hdl(k).XData + ux;
            Htmp(k).YData = copy_obj_in_memory.hdl(k).YData + uy;
        end
...
% Distance ------------------------
    function distance_move(varargin)
        ...
        elseif click_count < Nclicks
            ...
            a = textangle(a);
            r = hypot(diff(x),diff(y));
            str = sprintf('%.2f %s',r.*pixelsize(1),unit);
            set(Htmp(1:4),'XData',x,'YData',y);
            set(Htmp(5),'Position',[mean(x), mean(y), 0],'Rotation',-a,'String',str);
        end
    end
...
% Caliper ------------------------
    function caliper_move(varargin)
        ...
        elseif click_count == 2
            ...
            a = textangle(a);
            str = sprintf('%.2f %s',abs(D).*pixelsize(1),unit);
...
% Angle ------------------------
    function angle_move(varargin)
        ...
        elseif click_count == 2
            ...
            str = sprintf('%.2f %s',(180/pi)*abs(da),deg);
...
% ===========================================================
    function update_measurement(i,j)
        ...
        if strcmpi(type,'Calibration')
            ...
            str = sprintf('%.2f %s',pixelsize(1),unit);
        ...
        elseif strcmpi(type,'Caliper')
            ...
            a = textangle(a);
            A(i).obj(j).val = abs(D);
            str = sprintf('%.2f %s',A(i).obj(j).val*pixelsize(1),unit);
        ...
        elseif strcmpi(type,'Polyline')
            ...
            str = sprintf('%.2f %s',r.*pixelsize(1),unit);
            set(hdl(1:4),'XData',x,'YData',y);
            set(hdl(5),'Position',[mean(x([1,2])), mean(y([1,2])), 0],'Rotation',-a,'String',str);
    ...
    function image_fun(varargin)
        ...
        elseif strcmpi(type,'del')
            ...
            if ~isempty(selected)
                ...
                currentfig = [];
                if numel(selected) == 1
                    set(Hs,'string','Add: 1 file removed from the list');
                else
                    set(Hs,'string',sprintf('Add: %d files removed from the list',numel(selected)));
                end
            end
        end
    end
...
% ---------------------------------------------
    function calib_fun(varargin)
        ...
        elseif strcmpi(type,'apply')
            ...
            set(Hs,'String','The current image calibration applied to selection')
...
% ---------------------------------------------
    function options_fun(varargin)
        ...
        if ~isempty(Hp1)
            set(Hp1,'Color',color.val(PlotColors(1),:),'Marker',markers{PlotMarkers(1)},'MarkerSize',MarkerSize,'LineWidth',LineWidth(1));
        end
        if ~isempty(Hp2)
            set(Hp2,'Color',color.val(PlotColors(2),:),'Marker',markers{PlotMarkers(2)},'MarkerSize',MarkerSize,'LineWidth',LineWidth(2));
        end
        if ~isempty(Hp3)
            set(Hp3,'Color',color.val(PlotColors(1),:),'Marker','none','MarkerSize',MarkerSize,'LineWidth',LineWidth(1));
        end
        if ~isempty(Hp4)
            set(Hp4,'Color',color.val(PlotColors(2),:),'Marker','none','MarkerSize',MarkerSize,'LineWidth',LineWidth(2));
        end
        if ~isempty(Hp5)
...
% ---------------------------------------------
    function H = create_obj(type)
        ...
        set(H(1),'Color',color.val(PlotColors(1),:),'Marker',markers{PlotMarkers(1)},'LineWidth',LineWidth(1),'MarkerSize',MarkerSize);
        set(H(2),'Color',color.val(PlotColors(2),:),'Marker',markers{PlotMarkers(2)},'LineWidth',LineWidth(2),'MarkerSize',MarkerSize);
        set(H(3),'Color',color.val(PlotColors(1),:),'Marker','none','LineWidth',LineWidth(1),'MarkerSize',MarkerSize);
        set(H(4),'Color',color.val(PlotColors(2),:),'Marker','none','LineWidth',LineWidth(2),'MarkerSize',MarkerSize);
...
% ---------------------------------------------
    function update_obj(obj)
        ...
        for k = 1:numel(obj)
            ...
            if strcmpi(type,'Calibration')
                set(hdl(5),'String',sprintf('%.2f px',val));
            elseif strcmpi(type,'Angle')
                set(hdl(5),'String',sprintf('%.2f%s',val,deg));
            else
                set(hdl(5),'String',sprintf('%.2f %s',val.*pixelsize(1),unit));
            end
        end
    end
...
% = Help =============================================
    function help_fun(varargin)
        ...
        txt = {;
            ...
            ' obj(j).val       : the measurement value, as displayed in the text box'
            ' obj(j).points    : the vertices of the measurement as a Nx2 matrix'
